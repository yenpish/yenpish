...
| Project | Description |
|---------|-------------|
| 🦠 **Outbreaker** | Android serious game developed using Kotlin & Jetpack Compose. |
| 🎮 **Chazo: Fatebound** | 2D top-down RPG developed using Godot Engine. |
| 💰 **AI Spending Decision Assistant** | AI-powered spending assistant developed during UMHackathon 2026. |
